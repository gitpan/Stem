...
my %type_to_code = (
	...
	'hash'		=> \&type_hash,
	'list'		=> \&type_list,
	'HoL'		=> \&type_hash_of_list,
	'LoL'		=> \&type_list_of_list,
	'HoH'		=> \&type_hash_of_hash,
	'LoH'		=> \&type_list_of_hash,
	'addr'		=> \&type_address,
...
# the callback should return 
		...
		if ( my $env_name = $field->{'env'} ) {
                        ...
                        my @prefixes = '';
                        unshift @prefixes, "${reg_name}_" if $reg_name ;
...
#print "field $field_name [$field_val]\n" ;
		...
		if ( my $type = $field->{'type'} ) {
			...
			my $err = $type_code->( \$field_val, $type ) ;
			return $err if $err ;
		}
...
sub type_address {
	...
	return "Attribute value '${$val_ref}' is not a valid Stem address"
}
...
sub type_list {
	...
	my $err = convert_to_list( $val_ref ) ;
...
sub type_hash {
	...
	my $err = convert_to_hash( $val_ref ) ;
